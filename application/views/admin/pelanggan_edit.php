                                    ...
                                    <div class="card-body">
                                        <form method="POST" enctype="multipart/form-data" action="<?php echo base_url(); ?>admin/pelanggan/edit_aksi">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                  <input type="text" name="nama" class="form-control" id="horizontal-firstname-input" placeholder="Nama" name="nama" value="<?php echo $pelanggan['nama']; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <select class="form-select" name="jenkel" required>
                                                        ...
                                                        <option value="laki-laki" <?php if($pelanggan['jenkel'] == 'laki-laki') echo 'selected'; ?>>Laki-laki</option>
                                                        <option value="perempuan" <?php if($pelanggan['jenkel'] == 'perempuan') echo 'selected'; ?>>Perempuan</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <input class="form-control" type="date" name="tgl_lahir" id="example-date-input" value="<?php echo $pelanggan['tgl_lahir']; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Alamat</label>
                                                <div class="col-sm-9">
                                                    <textarea class="form-control" name="alamat" placeholder="Alamat" rows="3" name="alamat"><?php echo $pelanggan['alamat']; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">No HP</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="nohp" class="form-control" id="horizontal-firstname-input" name="nohp" placeholder="No HP" value="<?php echo $pelanggan['no_hp']; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="horizontal-firstname-input" class="col-sm-3 col-form-label">Username</label>
                                                <div class="col-sm-9">
                                                  <input type="text" name="username" class="form-control" id="horizontal-firstname-input" name="username" placeholder="Username" value="<?php echo $pelanggan['username']; ?>">
                                                </div>
                                            </div>
                                            <div class="row mb-4">
