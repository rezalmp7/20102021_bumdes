                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="<?php echo base_url(); ?>admin/umkm/tambah_aksi">
                                            <div class="row mb-4">
                                            ...
                                            <div class="row mb-4">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="alamat" id="basicpill-address-input" class="form-control" rows="2" placeholder="Alamat"></textarea>
                                                </div>
                                            </div>
                                            <div class="row mb-4">
                                                <label for="horizontal-password-input" class="col-sm-3 col-form-label">No Hp</label>
                                                <div class="col-sm-9">
                                                  <input type="number" name="nohp" class="form-control" id="horizontal-password-input" placeholder="No HP">
                                                </div>
                                            </div>
