                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-xl-4">
                                                <div class="p-4">
                                                    ...
                                                    <div class="mt-4 pt-2">
                                                        <a href="index.html" class="btn btn-primary w-100">See All Balances <i
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="buy-tab" role="tabpanel">
                                                <div class="float-end ms-2">
                                                    <h5 class="font-size-14"><i class="bx bx-wallet text-primary font-size-16 align-middle me-1"></i> <a href="index.html#!" class="text-reset text-decoration-underline">$4335.23</a></h5>
                                                </div>
                                            ...
                                            <div class="tab-pane" id="sell-tab" role="tabpanel">
                                                <div class="float-end ms-2">
                                                    <h5 class="font-size-14"><i class="bx bx-wallet text-primary font-size-16 align-middle me-1"></i> <a href="index.html#!" class="text-reset text-decoration-underline">$4235.23</a></h5>
                                                </div>
