            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                        ...
                        <div class="col-sm-6 col-lg-4 mix <?php echo $a['nama_kategori']; ?> center-table">
                            <div class="products-item">
                                <div class="top">
                                    ...
                                    $gambar = $a['gambar'];
                                    ?>
                                    <div class="col-12 m-0 p-0" style="aspect-ratio: 10/9; background-image: url('<?php echo base_url(); ?>assets/img/produk/<?php echo $gambar; ?>')"></div>
                                    <div class="inner">
                                        <h3>
                    ...
                    <div class="text-center">
                        <a class="common-btn" href="<?php echo base_url(); ?>produk">
                            Lihat Lebih
