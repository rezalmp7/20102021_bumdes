...
class Umkm extends CI_Controller {
	...
	public function detail($id)
	{
		...
		$where_produk = array('umkm' => $id, );
		$data['produk'] = $this->M_admin->select_select_where_join_2table_type_orderBy('produk.nama as nama_produk, produk.harga, produk.gambar, produk.id, kategori.nama as nama_kategori, produk.status', 'produk', 'kategori', 'produk.kategori = kategori.id', $where_produk, 'left', 'produk.create_at DESC')->result_array();

		$this->load->view('admin/layout/header');
		$this->load->view('admin/umkm_detail', $data);
		$this->load->view('admin/layout/footer');
	}
}
